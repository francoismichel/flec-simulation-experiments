...
if [[ $# -lt 2 ]]; then
    ...
    docker run --cap-add=SYS_PTRACE --security-opt seccomp=unconfined --security-opt apparmor=unconfined --entrypoint bash --rm -v $DIR/myscripts:/home/ns3dce/dce-linux-dev/source/ns-3-dce/myscripts -v $DIR:/pquic-ns3-dce -v $1:/home/ns3dce/pquic pquic-ns3-dce $2
fi
